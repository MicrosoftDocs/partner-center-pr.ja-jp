...
CSP のアプリケーションを入力すると、MPN ID、完全な住所、銀行情報、および職場メールをパートナー センターの管理者になる従業員の必要があります。
...
> [!IMPORTANT]  
> 現在、CSP パートナーが別の CSP パートナーにオンライン サービスを再販することはできません。 この制限は、CSP 取引の実行に使用されるテナントにのみ適用されます。 自社の社内向けに CSP 以外のテナントを使用する CSP パートナーは、別の CSP パートナーからオンラインサービスを購入できます。 Microsoft では、すべてのプログラムのポリシーと機能を継続的に見直しています。 機能のリリースに関するすべての新情報は、パートナー センターなど、通常の通信チャネルを通じて伝達方法です。
...
2. グローバル管理者は、パートナー センターで、アカウントを設定する必要があります。 全体管理者は、組織を追加できます役割とアクセス許可が、し、組織のプロファイルをセットアップ作業内容によって、パートナー センターで作業する従業員割り当て。
