...
## [職場の電子メール アドレスを取得する](buy-email-domain.md)
## パートナー センターへの移動
### [PAC からの移動 - 概要](pac-to-pc-overview.md)
### [PAC と PC のタスクを比較する](moving-from-pac-to-pc.md)
### [PC で PAC タスクを実行する](o365-partner-admin-center-to-partner-center.md)
## PMC からの移動
### [PMC からの移行の準備](prepare-pmc-pc-migration.md)
### [PMC からの移行ガイド](guide-to-migration.md)
### [PMC と PC を比較する](move-pmc-pc-map.md)
### [多くの企業を移動する](move-multiple-companies.md)
### [企業を統合する](consolidate-accounts.md)
...
## [Azure Expert MSP になる](azure-expert-msp.md)
## メリット
...
## ソフトウェア アシュアランス
### [プログラムの概要](software-assurance-lp.md)
### [トレーニング受講券 (SATV)](software-assurance-satv.md)
### [計画サービス (PS)](software-assurance-dps.md)
#### [資格要件](software-assurance-dps-requirements.md)
## 請求と税金
### [MPN での請求と税金](mpn-view-print-maps-invoice.md)
## [新機能のテスト](test-drive-new-features.md)

# [クラウド ソリューション プロバイダー (CSP)](csp-overview.md)
## [CSP プログラムに登録する](enrolling-in-the-csp-program.md)
## [Microsoft Partner Agreement - CSP](microsoft-partner-agreement.md)
## [CSP の直接パートナーの要件](direct-partner-new-requirements.md)
## [Microsoft 顧客契約 (地域、言語別)](agreements.md)
## [制限付きの直接請求アクセス](restricted-direct-bill-capabilities.md)
## [CSP 直接請求を間接リセラーに切り替える](transition-direct-to-indirect.md)
## [CSP 契約、価格表、キャンペーン](csp-documents-and-learning-resources.md)
## [CSP 用の Cloudyn 製 Azure Cost Management](azure-cost-management-app-for-csp-partners.md)
## [CSP の地域市場、通貨](regional-authorization-overview.md)
...
## [顧客アカウントに複数のユーザーをインポートするためのファイルの必須フィールド](file-customer-users.md)
