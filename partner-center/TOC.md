...
### [米国政府機関向け Microsoft Cloud のパートナー センターへの登録](enroll-in-csp-for-microsoft-us-govt-cloud.md)
...
### [Microsoft Cloud ドイツのパートナー センターへの登録](enroll-in-csp-for-microsoft-cloud-germany.md)
...
## [プランと料金の確認](see-offers-and-pricing.md)
