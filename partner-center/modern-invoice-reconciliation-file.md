...
| CustomerCountry | 顧客が配置されている国。 お客様の地域の [国の](/partner-center/regional-authorization-overview) 完全な一覧をご覧ください。  | *DE* |
| InvoiceNumber | 調整ファイルに関連付けられている請求書番号。  | *G002297372* |
| MpnId | CSP パートナーの MPN 識別子。 詳細については、「 [パートナー別に明細を表示する方法](/partner-center/use-the-reconciliation-files#itemize-reconciliation-files-by-partner)」を参照してください。 | *6034453* |
...
| ChargeType | 料金または調整 [の種類](/partner-center/recon-file-charge-types) 。 | *[新規作成]* |
...
| EffectiveUnitPrice | 請求サイクルのコストを計算するための日割り単価。 割引、請求日の調整、およびその他の要因によって、有効な単価が決まります。 詳細については、「 [有効な単価の計算](/partner-center/effective-unit-price-calculation)」を参照してください。  | *0.03825* |
