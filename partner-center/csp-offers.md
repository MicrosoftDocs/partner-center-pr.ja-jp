...
- **対象の顧客が資格を満たしていることを確認します**。 多くのプランでは、顧客に販売するために特別な資格が求められます。 そのような特別なセグメントには、教育機関、非営利団体、Government Community Cloud (GCC) などがあります。 問題をログに記録する前に、まず顧客の資格が適切に設定されていることをご確認ください。 これを確認するには、顧客リストから顧客をクリックし、アカウントを表示します。 該当する場合は、アカウントに特別な資格が設定されます。 資格を満たしていない顧客に対して教育機関向けのものを購入しようとしても、そのようなプランはカタログに表示されません。 顧客を適格とすることに関する詳細は、[特別なセグメントに関するドキュメント](https://docs.microsoft.com/partner-center/get-special-pricing-for-offers)をご覧ください。
- **アドオンと基本プランのどちらを購入するのかを決定します**。 Microsoft 365 や Dynamics 365 などのライセンス ベースのサービスの多くは、基本プランとアドオンの両方についてカタログ購入が可能になっています。 基本プランのみをカタログで購入できます。 アドオンを購入するには、最初にカタログで基本プランを購入し、次に顧客の一覧から顧客を選択してから、基本プランのサブスクリプションを選択します。 アドオンは、この [サブスクリプションの管理] ページの基本プランに対して適用できます。 
- **製品が顧客の市場で販売可能であることを確認します**。 製品やサービスの多くは、特定の国の顧客にのみ販売されるように構成されています。 サポートされている国の一覧は、さまざまな価格表ファイルで確認できます。 ライセンスベースのサービスがサポートされている国は、[料金とプラン] ページのプラン一覧表に記載されています。
- **プランが価格表で入手可能になっていることを確認します**。 利用可能なプランの一覧は、月ごとに変更される可能性があります。 カタログにプランが見つからない場合は、 **[販売] > [料金とプラン]** ページの現在の価格表でプランが入手可能であることを確認してください。

### <a name="recommended-documents-related-to-purchasing-items-in-the-partner-center"></a>パートナー センターでの項目の購入に関連する推奨ドキュメント

- [パートナー センターの価格とプラン](https://docs.microsoft.com/partner-center/pricing-and-offers)
- [クラウド ソリューション プロバイダー プログラムのパートナー プランの概要](https://docs.microsoft.com/partner-center/csp-offers)
- [教育機関の顧客にプランを販売する方法 & パートナーセンターで教育機関の顧客を作成する方法](https://docs.microsoft.com/partner-center/sell-to-education-customers)
- [教育、非営利団体、政府機関のユーザーなどの特別な業界への販売](https://docs.microsoft.com/partner-center/get-special-pricing-for-offers)
- [特別なセグメントの購入ルール](https://docs.microsoft.com/partner-center/get-special-pricing-for-offers#purchase-rules-for-special-segments)
