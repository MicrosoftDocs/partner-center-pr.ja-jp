...
- **対象の顧客が資格を満たしていることを確認します**。 多くのプランでは、特別な資格を顧客に販売する必要があります。 特別な業界には、教育、非営利の Government Community Cloud (GCC) などがあります。 イシューをログに記録する前に、最初に顧客の資格が適切に設定されていることを確認します。 確認するには、顧客リストから顧客をクリックし、アカウントを表示します。 該当する場合は、アカウントに特別な資格が設定されます。 資格を満たしていない顧客に対して教育機関向けのものを購入しようとしても、そのようなプランはカタログに表示されません。 顧客を適格とすることに関する詳細は、[特別なセグメントに関するドキュメント](https://docs.microsoft.com/partner-center/get-special-pricing-for-offers)をご覧ください。
- **アドオンと基本プランのどちらを購入するのかを決定します**。 Microsoft 365 や Dynamics 365 などのライセンスベースのサービスの多くでは、基本プランとアドオンの両方をカタログ購入できます。 カタログで購入できるのは基本プランのみです。 アドオンを購入するには、最初にカタログで基本プランを購入し、顧客リストから顧客を選択してから、基本プランのサブスクリプションを選択します。 アドオンは、この [サブスクリプションの管理] ページの基本プランに適用できます。 
...
- [プランを教育機関の顧客に販売し、教育機関の顧客を作成する方法](https://docs.microsoft.com/partner-center/sell-to-education-customers)
- [教育、非営利団体、官公庁/自治体のユーザーといった特別な業界への販売](https://docs.microsoft.com/partner-center/get-special-pricing-for-offers)
