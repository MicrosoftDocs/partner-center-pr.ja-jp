...
- **対象の顧客が資格を満たしていることを確認します**。 多くのプランでは、特別な資格を顧客に販売する必要があります。 特別な業界には、教育、非営利の Government Community Cloud (GCC) などがあります。 イシューをログに記録する前に、最初に顧客の資格が適切に設定されていることを確認します。 確認するには、顧客リストから顧客をクリックし、アカウントを表示します。 該当する場合は、アカウントに特別な資格が設定されます。 資格を満たしていない顧客に対して教育機関向けのものを購入しようとしても、そのようなプランはカタログに表示されません。 顧客を適格とすることに関する詳細は、[特別なセグメントに関するドキュメント](get-special-pricing-for-offers.md)をご覧ください。
