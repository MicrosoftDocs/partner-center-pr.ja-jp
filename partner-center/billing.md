...
請求書については、**[ダッシュボード]** メニューで **[請求]** を選びます。 この請求ページには、請求の履歴と傾向、当月 (年払いの場合は当年) の支払い残高、請求書や調整ファイルへのリンク、前回のお支払いが表示されます。
...
<td>課金の規則</td>
<td><ul>
<li>CSP プログラムについて、毎月 (年払いの場合は毎年) 単一の請求書が送られます。</li>
...
<li>調整とクレジットは、翌月 (または翌年) の請求書で、クレジットまたは調整の適用後に遅れて表示されます。</li>
</ul></td>
</tr>
<tr class="even">
<td>税金</td>
...
<td>タイミング</td>
<td>
ライセンスベースの請求は、月単位または年単位で実行できます。 いずれかを選ぶには、以下の手順を実行します。
<ol>
<li>顧客を選びます。</li>
<li>[サブスクリプションの追加] をクリックします。</li>
<li>[請求頻度] の下で、[毎月] または [毎年] のいずれかを選びます  (注: このオプションは、いったん選択すると変更できません)。</li>
<li>カタログからサブスクリプションを選びます。</li>
</ol>
</ul></td>
</tr>
</tbody>
...
## <a href="" id="licensebasedbilling"></a>ライセンスベースの課金
...
<li>請求は、年間サブスクリプションごとに 12 回の月払いまたは 1 回の年払いになります。</li>
...
<li>ライセンスベースのサービスに対する取り消しのクレジットは、期間途中の取り消しについては未使用日数分が日割り計算されます (前の式に従ったライセンスの減少も同様です)。</li>
</ul></td>
</tr>
<tr class="odd">
<td>タイミング</td>
