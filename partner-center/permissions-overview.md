...
>[!Note]
> Azure Active Directory (AAD) テナント ロールには、グローバル管理者、ユーザー管理者、および CSP のロールが含まれます。 AAD 以外のロールには、MPN 管理者、ビジネス プロファイル管理者、紹介管理者、インセンティブ管理者、インセンティブ ユーザーが含まれます。 
...
## <a name="manage-mpn-membership-and-your-company-non-aad-roles"></a>MPN メンバーシップと貴社の管理 (非 AAD ロール)
...
## <a name="manage-referrals-non-aad-roles"></a>紹介の管理 (非 AAD ロール)
...
## <a name="manage-incentives--non-aad-roles"></a>インセンティブの管理 (非 AAD ロール)
