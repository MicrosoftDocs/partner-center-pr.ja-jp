...
>[!Note]
> Azure Active Directory (AAD) テナント ロールには、グローバル管理者、ユーザー管理者、および CSP のロールが含まれます。 非 AAD のロールは、テナントを管理しないロールおよび MPN 管理者、ビジネス プロファイルの管理、参照の管理、インセンティブの管理者およびインセンティブのユーザーが含まれます。 
...
## <a name="manage-mpn-membership-and-your-company-non-aad-roles-these-roles-manage-the-company-business-rather-than-the-tenant"></a>MPN メンバーシップと、会社の管理 (非 AAD のロール: これらのロール管理、テナントではなく、会社のビジネス)

|**ロール** | **できること**|
|----------------------------|:----------------------------|
|MPN パートナー管理者|• ビューの作成、およびパートナー サービス要求の管理||
||• ビューの法律、会社、ビジネス、および MPN プロファイル
||• ユーザーの詳細およびスキル データの表示
||• コンピテンシーの表示
||• 特典の表示と管理
||• MPN オファーの表示と購入
||• MPN オファーの注文履歴と請求書の表示
||• パートナー コントリビューション インジケーター データの表示
||• 利用券検証ツールでの作業|
||- 顧客データ分析の表示
|| 会社内の他のユーザー ロールの表示が、ロールを割り当てることはできません
|アカウント管理者| 場所を追加します。
...
## <a name="manage-referrals"></a>参照を管理します。 

|**ロール**|**できること**|
|-----------------------------|:------------------------|
|紹介管理者       |• ビジネス プロファイルの表示、作成、管理
||• 紹介案件の受信と管理
||• ビューの作成、および共同販売の参照の管理|
||• パートナー サービス要求の表示、作成、管理
|ビジネス プロファイル管理者   |• ビューの作成、およびビジネス プロファイルの管理 
||• パートナー サービス要求の表示、作成、管理|

## <a name="manage-incentives"></a>インセンティブを管理します。 
