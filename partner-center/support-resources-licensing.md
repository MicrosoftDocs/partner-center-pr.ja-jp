...
|目的  | 参照先  |
|:------------------|:--------------- |
|CSP プログラムのライセンスを他のライセンスモデルと比較する *(概要)* | [CSP の登録ページ](https://partner.microsoft.com/licensing/)にアクセスします。 [ *CSP を他のライセンスモデルと比較する*] セクションが表示されるまで下にスクロールします。  |
...
これらの他のリソースが役に立つ場合があります。 これらのリソースの一部にアクセスするには、最初に [MPN プログラム](https://partner.microsoft.com/membership)に登録する必要があります。
...
間接プロバイダー (CSP プログラムの場合) またはプログラムディストリビューターは、ライセンスまたは顧客取引に関する特定の質問の多くに回答できるようにする必要があります。 次のリソースも役に立ちます。

|目的  | 解決方法については、  |
|:------------------|:--------------- |
|パートナーまたはディストリビューターを検索する | [支援を受けるパートナーを見つける](find-a-partner.md)  |
