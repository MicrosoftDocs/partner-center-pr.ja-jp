...
-   **移行元** (既存の) アカウントで**ダッシュボード**にサインインし、すべての顧客と、それらの顧客にプロビジョニングされているすべてのサービスをメモします。
...
1.  **移行先** (新しい) アカウントで**ダッシュボード**にサインインし、**[顧客]** から顧客一覧に移動します。
...
1.  **移行元**の CSP アカウントで**ダッシュボード**にログオンし、顧客一覧に移動します。
