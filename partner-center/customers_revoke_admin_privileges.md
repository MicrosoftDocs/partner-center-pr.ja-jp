...
顧客は、Office 365 管理ポータルを使って、テナントの管理特権を持つパートナーを確認することができます。 これを行うには :
...
各 Azure サブスクリプションには、独自のリソース管理ロールのセットがあります。 CSP パートナーが顧客の Azure サブスクリプションを管理できるようにするには、そのパートナーが Azure サブスクリプションの1つ以上のロールに割り当てられている必要があります。 具体的な内容は次のとおりです。
