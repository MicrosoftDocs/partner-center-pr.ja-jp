...
---
# <a name="co-sell-connector-for-salesforce-crm---overview"></a>Salesforce CRM の共同販売コネクタ-概要
...
|Salesforce CRM|CRM ユーザーロールは、システム管理者またはシステムカスタマイザーです。|[Dynamics 365 でロールを割り当てる](https://docs.microsoft.com/dynamics365/customerengagement/on-premises/customize/privileges-required-customization)|
