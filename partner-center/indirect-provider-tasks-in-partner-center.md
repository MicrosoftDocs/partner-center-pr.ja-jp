...
-   [マイクロソフトの公式な間接プロバイダーの一覧](https://partnercenter.microsoft.com/en-us/partner/find-a-provider)に貴社を掲載する 
...
パートナー センターで間接リセラーや顧客とのパートナーシップを確立して管理するには、次の手順を実行します。 手順 2 および 3 については、後ほど詳しく説明します。

1.  [マイクロソフトの公式な間接プロバイダーの一覧](https://partnercenter.microsoft.com/en-us/partner/find-a-provider)で、貴社のプロファイルを確認します。 

    -   貴社の間接プロバイダーのプロファイルを変更するには、会社名、ロゴ、ターゲット URL を記載したサポート要求を貴社の拠点ごとに作成して、パートナー センターに提出してください。 プロファイルは、2 ～ 3 週間以内に更新されます。<br>
...
5.  If the order is correct, select **Submit**. 注文が誤っている場合は、**[キャンセル]** を選んですべての操作を取り消し、最初からやり直します。

6.  注文を送信すると、**[確認]** ページが表示されます。 **[セットアップ情報]** に、管理者ユーザーのアカウント名と一時パスワードが表示されます。 Copy down the user account name and password information so you can send it on to the new customer. 
