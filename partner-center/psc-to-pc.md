...
ご存じのように、会社は2020年12月31日の投稿にアクセスできなくなります。 取引を管理し、パートナーセンターで Microsoft の販売者から送信された取引を処理するために必要なすべてのものを見つけることができます。 ただし、違いはありますが、次のガイダンスを参考にして、パートナーセンターへの移行を円滑に進めることができます。
...
- 会社の [アカウント管理者](https://docs.microsoft.com/partner-center/permissions-overview#manage-mpn-membership-and-your-company-non-aad-roles-these-roles-manage-the-company-business-rather-than-the-tenant) は、[紹介] タブへのアクセスを許可できます。アカウント管理者を見つけるには、パートナーセンターの右上にある歯車アイコンから [パートナー設定] にアクセスします。 左側のナビゲーションバーの2番目のレベルで [ユーザー管理] ページを選択します。 ページの右上にある [すべてのユーザー] を表示するドロップダウンをクリックし、"Account Admins" に変更します。 このページには、すべてのアカウント管理者が、それぞれの電子メール Id と共に表示されます。 これらのユーザーに連絡して、職場アカウントの "参照管理者" アクセスを取得してください。
 ...
 :::image type="content" source="images/pscmigration/accountadmin.png" alt-text="[パートナー設定] ユーザー管理ページのアカウント管理者を示す画像":::
...
企業が PDM を所有している場合-パートナーセンターアカウントがセットアップされていて、ユーザーが移動し、ロールとアクセス許可を持っている場合は、パートナーセンターに共同販売活動を移動できます。 スイッチを作成するように PDM に通知します。これにより、すべての新しい取引がパートナーセンターに送られるようになります。
>[!Note]
...
|共同販売要求|Microsoft 販売者によって開始されたパートナーによる明示的な ask はありません。|パートナーは、Microsoft の販売者向けヘルプが必要な場合は、 [明示的な要求](https://docs.microsoft.com/partner-center/manage-co-sell-opportunities#add-solutions) を行う必要があります。 Microsoft 販売者には、要求を拒否するオプションがあります。|
...
|ソリューション|1つの価格表のみに属するソリューションは、取引に追加できます。|パートナーは、次のリストに属する [ソリューション](https://docs.microsoft.com/partner-center/manage-co-sell-opportunities#add-solutions) を追加できます。 a) Microsoft ファーストパーティカタログのソリューション b) ソリューション (取引先: PSC の取引先) と c) 他のサードパーティパートナー (取引先: PSC の ISV) からのソリューションの共同販売。|
...
### <a name="home-page-of-psc-and-default-view-of-the-co-sell-opportunities-in-partner-center"></a>パートナーセンターにおける PSC のホームページと共同販売機会の既定のビュー
...
### <a name="deal-details-view-in-psc-and-partner-center"></a>PSC とパートナーセンターの案件の詳細ビュー
...
- 推定ソリューションの終了日は、OEM IOT 取引でのみ使用できます。 その他の種類の取引では表示されません。
...
### <a name="psc-add-products-view-and-the-partner-center-add-solutions-view"></a>PSC [製品の追加] ビューとパートナーセンターの [ソリューションの追加] ビュー
...
### <a name="user-management-in-psc-and-partner-center"></a>PSC およびパートナーセンターでのユーザー管理
...
### <a name="user-role-assignment-in-psc-and-partner-center"></a>PSC およびパートナーセンターでのユーザーロールの割り当て

- PSC 管理者の同等の役割は、パートナーセンターのアカウント管理者ロールです。
- パートナーセンターには、参照管理者ロールである共同販売取引管理のロールが1つだけあります。
- PSC のすべての取引マネージャーと販売元に、参照管理者ロールが割り当てられている必要があります。
...
### <a name="notifications-in-psc-and-partner-center"></a>PSC およびパートナーセンターでの通知
...
### <a name="q-the-new-deal-button-is-greyed-out-for-our-account-what-should-i-do-to-start-creating-deals"></a>Q. アカウントでは、[+ 新しい商談] ボタンがグレーで表示されます。 取引の作成を開始するにはどうすればよいですか?
...
### <a name="q-can-i-assign-deals-to-a-specific-person-from-our-organization-like-psc"></a>Q. PSC などの組織の特定の担当者に取引を割り当てることはできますか。

チームメンバーを特定の取引に割り当てることができます。 他の参照管理者がこれらの取引を表示または操作することをブロックすることはありません。 

### <a name="q-is-there-a-view-of-all-the-deals-assigned-to-me"></a>Q. 自分に割り当てられているすべての取引のビューはありますか。

[お気に入り] 機能を使用できます。これは [ユーザーレベル] タブです。自分に割り当てられているすべての取引をお気に入りとしてマークして、取引にすばやくアクセスできるようにすることができます。

### <a name="q-is-there-a-read-only-view-for-the-deals"></a>Q. 取引の読み取り専用ビューはありますか。

いいえ。参照セクションには、取引の読み取り専用ビューはありません。 すべての紹介管理者は、すべての取引に対する完全な読み取りと書き込みアクセス権を持ちます。

### <a name="q-how-can-i-register-a-deal-after-making-it-as-won"></a>Q. 商談を獲得後に登録するにはどうすればよいですか。
...
### <a name="q-i-get-an-error-message-when-i-click-on-new-deal-registration-button-in-the-deal-registration-section-how-can-i-register-my-deals"></a>Q. [取引登録] セクションで [+ 新しい取引登録] ボタンをクリックすると、エラーメッセージが表示されます。 取引を登録するにはどうすればよいですか。
...
### <a name="q-is-adding-a-customer-organization-mandatory"></a>Q. 顧客組織を必須として追加していますか?
...
### <a name="q-are-customer-contact-details-mandatory"></a>Q. カスタマー連絡先の詳細は必須ですか?
...
### <a name="q-how-many-solutions-can-i-add-to-a-deal"></a>Q. 商談に追加できるソリューションの数を教えてください。

商談には、最大50のソリューション (PSC の製品) を追加できます。 PSC とは異なり、お客様独自の共同販売対象ソリューションのソリューション、Microsoft ファーストパーティの Sku、およびその他のサードパーティの共同販売対象ソリューションを組み合わせることができます。 パートナーセンターで選択または使用できる取引の役割はありません。 Microsoft の Sku では、必要に応じて、追加された各 SKU の数量と価格を追加することができます。

### <a name="q-when-will-i-get-to-know-the-microsoft-seller-details-after-creating-a-deal"></a>Q. 商談を作成した後に Microsoft 販売者の詳細情報を確認するには、どうすればよいでしょうか。
...
### <a name="q-where-can-i-find-the-opportunity-id"></a>Q. 営業案件 ID はどこで確認できますか。

PSC の営業案件 ID は、PC の取引 ID と同じです。 商談を開くと、取引名の横に取引 ID が表示されます。

### <a name="q-how-can-my-pdm-get-access-to-pc"></a>Q. PDM から PC にアクセスするにはどうすればよいですか。

PSC とは異なり、パートナーセンターには、直接 PDMs からアクセスすることはできません。 この機能を有効にするには、次のような複数のオプションがあります。

- OCP Insights-PDMs がそれらに関連する & の進行状況を表示するだけの場合は、OCP Insights ポータルを使用して組織のビューを取得できます。 これは内部ツールであり、PDMs とユーザーのみが使用できます。
