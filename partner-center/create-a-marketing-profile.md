...
*  **[ソリューション プロバイダーの検索](https://partnercenter.microsoft.com/pcv/search)を使った検索**。 お客様は、パートナーの一覧をセルフサービスで検索し、検索条件を使ってパートナーを絞り込むことができます。
...
> [!IMPORTANT]  
> ために業務を効率化、パートナーをパートナー センターのこのサイトにいくつかのツールと web サイトで分散するために使用するの機能に統合されています。 その取り組みの一環として、すべての参照に関連する機能をパートナー センターに移動し、Pinpoint と C2PC サイトを廃止しました。 を使用した場合 Pinpoint または C2PC までを取得し、Microsoft からの参照の管理は、引き続きの参照を取得する、パートナー センターで新しいビジネス プロファイルを作成する必要があります。 これらのサイトからプロファイルをインポートすることはできなくなりました。 
...
パートナー センターを通じた顧客と成功をデモンストレーションするか、または他の Microsoft の認定やプログラムへの参加と、特定の製品、サービス、その成功に貢献する業界の承認に自動的に追加します。 推薦は検索結果における重要な要素です。
