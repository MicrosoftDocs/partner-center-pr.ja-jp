...
>**注** ビジネス プロファイルを作成するには、パートナー ダッシュボードのアカウントが必要です。 パートナー ダッシュボードのアカウントがない場合は、「[パートナー ダッシュボード アカウントを作成する](mpn-create-a-partner-center-account.md)」を参照して作成してください。 
...
2.  **[ビジネス プロファイルの作成]** ページで、地域を選択してから、プロファイル情報を入力します。
    ...
    >**注** パートナー ダッシュボードでは複数の言語がサポートされますが、説明や自由形式のタグなどの一部の要素には、このトピックで説明しているように複数の言語のテキストを含める必要があります。
