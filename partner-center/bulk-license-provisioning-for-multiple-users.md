...
パートナー センターでは、追跡し、すべてのお客様が所有するライセンス権利を示しています。

## <a name="in-this-section"></a>このセクションの内容


-   [複数のユーザーにライセンスを割り当てる](#assign-licenses-to-groups)
-   [ユーザーのライセンス割り当ての取り消し](#revoking-licenses)
...
8.  **[保存]** を選びます。 パートナー センターが表示されます、**ライセンス更新**の確認 ページ、ユーザーおよびその新しいライセンスを一覧表示します。

**注**  一部のマイクロソフト製品は特定の場所では使用できません。 また、他の製品やサービスに依存する製品や、同じユーザーに一緒に割り当てることができない製品もあります。 保存すると、確認ページに、成功したライセンス割り当てに関するすべてのユーザーの結果と、ライセンス割り当てのエラーの一覧が表示されます。
