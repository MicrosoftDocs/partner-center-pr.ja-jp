...
毎月の請求日は、登録時に選んだ日付です。 Microsoft は、請求日が記載された確認の電子メールを送信します。

価格表は毎月更新され、1 か月前に確認することができます。 ライセンスベースの価格は、サブスクリプションの有効期間 (通常は購入日から 12 か月間) にわたって保証されます。 使用量ベースの価格は、毎月変わる場合があります。 価格の変更については、パートナーの価格表を発行して、30 日前に通知します。


### <a name="payment-terms"></a>支払条件

支払条件は、net 60 日間です。 支払いは、請求書の期限 (請求日から 60 日後) までに行う必要があります。そうしないと、そのアカウントは延滞していることになります。

延滞のあるアカウントは、クラウド ソリューション プロバイダー プログラムからの中断または終了の対象となる場合があります。 中断されているアカウントは、新しい顧客や注文の作成、再販業者関係の要求、サブスクリプションの数量の増減、アドオン サブスクリプションの注文、サブスクリプションの変換や移行を行うことができません。アカウントが復帰するまでは、既存の顧客、サブスクリプション、リソースを管理することだけが許可されます。 パートナーは、未払いの請求の支払いが完了したときに、中断されたアカウントのすべての機能を取り戻すことができます。
...
### <a name="invoice-availability"></a>請求書の可用性
...
課金契約は Microsoft と貴社の間で交わされるため、(顧客ではなく) 貴社の詳細に基づいて課税されます。 配布準備中に、またはサービス要求を通じて、税金 ID を提出できます。 料金は次の課金サイクルに反映されます。


          <strong>源泉徴収と売上税の除外</strong>については、サービス要求を通じて税金のドキュメントを提出する必要があります。 料金と適切な返金は次の課金サイクルに反映されます。


          <strong>付加価値税 (VAT) の免除</strong>については、サービス要求を通じて (Microsoft によって確認済みの)、VAT ID を提出する必要があります。 料金と適切な返金は次の課金サイクルに反映されます。
...
### <a name="billing-frequency"></a>
請求頻度

顧客の代理としてサブスクリプションを購入した場合は、月次または年次請求を選択できます。 後で、請求頻度を変更する場合は、次の手順を使用します。 

月次請求は多数のサブスクリプションがあり、それら共通の請求日に配置する場合は、月次請求を年次請求に切り替えると便利です。 月次請求を年次請求に切り替えることは、個々 のお客様の請求日の調整に便利です。 

請求頻度を変更することを検討するときは、次のことに注意してください。 

-   請求頻度を変更すると、年次という用語が、請求頻度を変更した日付と新しい更新日が確立されるを反映するように更新されます。 

-   という用語の年間サブスクリプションのみを変更することができます。試用版のサブスクリプションの頻度を変更することはできません。 

-   (たとえば、親サブスクリプションなど) の順序を共有するサブスクリプションがある場合は、すべてのそれらのサブスクリプションが更新されます。 

-   新しい用語には、経由では、適用されるプロモーションは実行されません。

-   価格は、以前の用語から継承していない、この変更時に適用されます。

-   順序を共有するすべてのサブスクリプションは、アクティブな状態である必要があります。

-   何回請求頻度を変更することができます。 


<b>サブスクリプションの請求頻度を変更するには</b>
<ol>
<li>パートナー センター メニューから<b>顧客</b>を選択し、サブスクリプションを変更する顧客を選択します。
<li>[顧客の<b>サブスクリプション</b>] ページを変更するサブスクリプションを選択します。 
<li>[詳細] ページの [<b>請求頻度</b>を<b>月次請求</b>または<b>年次</b>を選択します。 確認ページを変更するサブスクリプションの一覧と、請求頻度は、変更に関する重要な情報が表示されます。 
<li>変更を加えるには、 <b>[ok]</b>または元に戻すこと<b>をキャンセル</b>を選択します。 
</ol>

### <a name="billing-rules"></a>課金の規則
<ul>
<li>サブスクリプションは毎年自動更新されます。</li>
<li>12 か月の支払いか年間サブスクリプションごとに 1 つの年次支払請求ができます。</li>
...
現在、ライセンス ベースのサービスの取り消しに対して終了早期料金は課金されません。
...
現在、使用量ベースのサービスの取り消しに対して終了早期料金は課金されません。
