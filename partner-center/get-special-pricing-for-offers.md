...
- 状態所有エンティティは、 [資格条件](https://www.microsoft.com/legal/compliance/anticorruption/criteria)を満たしている必要があります。

特別プランを顧客に販売するための購入ルール:

|**顧客の種類**   |**販売可能**   |**販売できません**   |
|:----------------------------|:---------------------------------|:------------------------------------------|
| 商用 |商用 | 非営利団体、教育機関、または政府機関向けのコミュニティクラウド |
