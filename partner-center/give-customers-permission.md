...
- <span data-ttu-id="e51d7-129">選択した顧客に対してアクセス許可を有効にする (有効にする) ことができます。</span><span class="sxs-lookup"><span data-stu-id="e51d7-129">You can turn on (enable) permissions for any customer you choose.</span></span>
