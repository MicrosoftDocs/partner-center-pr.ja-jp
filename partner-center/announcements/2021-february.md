...
パートナー センターで共同販売を行うパートナー

### <a name="summary"></a>まとめ

共同販売を行っているパートナーは、新しいパートナー センターの CSV ファイル一括操作機能を使用して、大規模な販売機会をエクスポートおよびインポートできるようになりました。

### <a name="details"></a>詳細

共同販売を行っているパートナーは、新しいパートナー センターの CSV ファイル一括操作機能を使用して、大規模な販売機会をエクスポートおよびインポートできるようになりました。 この結果、紹介の共有エクスペリエンスが統合され、Partner Sales Connect から移行するときにビジネス継続性が確保されます。 パートナー センター API への投資の代替手段でもあります。

詳しくは、次のセクションで説明する記事を参照してください。 
...
________________
## <a name="migrate-your-deals-from-partner-sales-connect-psc-using-the-new-deal-migration-feature"></a><a name="12"></a>新しい取引移行機能を使用して Partner Sales Connect (PSC) から取引を移行する
...
Partner Sales Connect (PSC) で取引を行っているパートナーは、取引移行機能を使用して共同販売取引を移行すると、パートナー センター内で新しい共同販売エクスペリエンスを利用できます。

### <a name="details"></a>詳細

PSC で取引を行っているパートナーは、より速やかに移行して、パートナー センター内で新しい共同販売エクスペリエンスを利用でき、取引移行機能を使用して共同販売取引をパートナー センターに移行すると、2 つのプラットフォームにまたがる作業を解消できます。
...
________________
## <a name="increased-flexibility-with-partner-led-co-sell-deals"></a><a name="11"></a>パートナー主導の共同販売取引による柔軟性の向上
...
パートナーは、パートナー主導の共同販売取引を作成した後で、Microsoft の販売者を招待して、共同販売活動を行えるようになりました。

### <a name="details"></a>詳細

パートナーは、パートナー主導の共同販売取引を作成した後で、Microsoft の販売者を招待するオプションを使用して、共同販売活動を行えるようになりました。 パートナーが Microsoft 販売者のヘルプを明示的に求めるまで、取引の詳細は Microsoft 販売チームと共有されません。 このシナリオは、Microsoft 販売者インセンティブの対象でもあります。

パートナー主導の共同販売取引は、取引を終了する前の任意の時点で、アクティブな共同販売にアップグレードできます。
...
________________
## <a name="changes-to-the-cloud-solution-provider-csp-customer-onboarding-requirements"></a><a name="10"></a> クラウド ソリューション プロバイダー (CSP) のお客様のオンボード要件の変更
...
その他の地域の顧客と提携しているパートナーは、2021 年 3 月 25 日に、顧客の **有効な識別子**、**電話番号**、**ミドル ネーム** を詳細情報として必要に応じて入力できるようになります。
...
- [Microsoft Compliance Manager で評価を構築して管理する](/microsoft-365/compliance/compliance-manager-assessments?preserve-view=true&view=o365-worldwide)
...
- [新しい SMB 接続の作成](../connect-with-your-customers.md): Microsoft 販売者と共同販売および協力して、SMB 顧客に関連するインバウンドの機会を獲得します。

- [紹介アクセス許可の展開](../permissions-overview.md#manage-referrals): パートナーの希望に基づいて、管理者アクセス許可 (すべての共同販売機会へのアクセス) またはユーザー アクセス許可 (ユーザーの特定の共同販売機会へのアクセス) のどちらかを、ユーザーの紹介アクセス許可を割り当てます。

- [Partner Sales Connect のユーザーの移行](../psc-to-pc.md#user-migration): Partner Sales Connect の既存のユーザー アクセス許可を、パートナー センターの対応する紹介管理者および紹介ユーザーのアクセス許可にマップした後、新しいアクセス許可をユーザーに一括で適用します。 紹介の管理の詳細については、[紹介のアクセス許可に関するドキュメント](../permissions-overview.md#manage-referrals)を参照してください。  

#### <a name="partners-with-co-sell-ready-offers"></a>共同販売に対応したオファーをお持ちのパートナー

- [他のパートナーとの共同販売](../manage-co-sell-opportunities.md): Microsoft の強力なパートナー エコシステムから別のパートナーを招待して共同販売を行い、新しい顧客対象にアクセスできるようにします。  
...
- [自動取引登録の使用](../register-deals.md): チェック ボックス [This deal/win has been or will be transacted through Azure Marketplace or AppSource]\(この案件/受注は、Azure Marketplace または AppSource を使用して取引された、または取引される\) を使用して、取引可能な Microsoft コマーシャル マーケットプレース Azure オファーを登録することにより、時間を節約して、正確さを保証します。 取引の日付が正しければ、案件登録の情報が Microsoft コマーシャル マーケットプレースから直接取得されます。

### <a name="questions"></a>わからないことがある場合は、

新機能の使用に関してサポートが必要な場合は、サポート情報の[紹介セクション](../referrals.md)、または[共同販売エクスペリエンス ギャラリー](https://aka.ms/CoSellExperience)で入手可能なハウツー サポート資料を参照してください (サインインが必要)。
