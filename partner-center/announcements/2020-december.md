...
- <span data-ttu-id="2a8f2-108">日付:2020 年 12 月 22 日</span><span class="sxs-lookup"><span data-stu-id="2a8f2-108">Date: 2020-12-22</span></span>
...
### <a name="next-steps"></a><span data-ttu-id="2a8f2-122">次のステップ</span><span class="sxs-lookup"><span data-stu-id="2a8f2-122">Next steps</span></span>
...
<span data-ttu-id="2a8f2-134">Microsoft は、すべての電子署名処理を DocuSign から Adobe Sign に移行する予定です</span><span class="sxs-lookup"><span data-stu-id="2a8f2-134">Microsoft will be transitioning all electronic signature processing from DocuSign to Adobe Sign</span></span>
...
<span data-ttu-id="2a8f2-149">質問がある場合は、[https://clt.partners.extranet.microsoft.com/CLT](https://clt.partners.extranet.microsoft.com/CLT) で Call Logging Tool (CLT) を使用するか [explore.ms](https://www.explore.ms/publichome.aspx) 経由で地域オペレーション センターにお問い合わせください。</span><span class="sxs-lookup"><span data-stu-id="2a8f2-149">If you have any questions, contact your Regional Operations Center using the Call Logging Tool (CLT) at [https://clt.partners.extranet.microsoft.com/CLT](https://clt.partners.extranet.microsoft.com/CLT) or via [explore.ms](https://www.explore.ms/publichome.aspx).</span></span> <span data-ttu-id="2a8f2-150">ご質問をできるだけ速やかに解決できるように、標準の CLT プロセスに注意深く従ってください。</span><span class="sxs-lookup"><span data-stu-id="2a8f2-150">Follow the standard CLT process closely so that we can resolve your query as quickly as possible.</span></span>
...
### <a name="categories"></a><span data-ttu-id="2a8f2-181">Categories</span><span class="sxs-lookup"><span data-stu-id="2a8f2-181">Categories</span></span>
...
### <a name="next-steps"></a><span data-ttu-id="2a8f2-196">次のステップ</span><span class="sxs-lookup"><span data-stu-id="2a8f2-196">Next steps</span></span>
...
### <a name="details"></a><span data-ttu-id="2a8f2-208">詳細</span><span class="sxs-lookup"><span data-stu-id="2a8f2-208">Details</span></span>
...
### <a name="impacted-audience"></a><span data-ttu-id="2a8f2-219">対象</span><span class="sxs-lookup"><span data-stu-id="2a8f2-219">Impacted audience</span></span>
...
### <a name="summary"></a><span data-ttu-id="2a8f2-276">まとめ</span><span class="sxs-lookup"><span data-stu-id="2a8f2-276">Summary</span></span>
...
### <a name="categories"></a><span data-ttu-id="2a8f2-313">Categories</span><span class="sxs-lookup"><span data-stu-id="2a8f2-313">Categories</span></span>
...
### <a name="categories"></a><span data-ttu-id="2a8f2-326">Categories</span><span class="sxs-lookup"><span data-stu-id="2a8f2-326">Categories</span></span>
...
<span data-ttu-id="2a8f2-342">このオファーの以下の価格の詳細については、2021 年 1 月の価格表をご覧ください。</span><span class="sxs-lookup"><span data-stu-id="2a8f2-342">The offer pricing details below for this offer will be in the January 2021 price list.</span></span>
...
- <span data-ttu-id="2a8f2-363">キャンペーン オファーは、2021 年 1 月 1 日に正式な CSP パートナー センターのライセンスベースの価格表とオファー一覧表でご確認いただけます。</span><span class="sxs-lookup"><span data-stu-id="2a8f2-363">The promo offer will be available in the January 1, 2021 official CSP partner center license-base price list and offer list matrix.</span></span> 
...
- [<span data-ttu-id="2a8f2-375">GetSelfServePolicies</span><span class="sxs-lookup"><span data-stu-id="2a8f2-375">GetSelfServePolicies</span></span>](/partner-center/develop/get-a-self-serve-policy-by-id)
...
- <span data-ttu-id="2a8f2-385">最新バージョン [MicrosoftPartnerCenter.NETSDK (NuGet ギャラリー | Microsoft.Store.PartnerCenter 1.16.3)](https://www.nuget.org/packages/Microsoft.Store.PartnerCenter/1.16.3) をダウンロードする</span><span class="sxs-lookup"><span data-stu-id="2a8f2-385">Download the latest version [MicrosoftPartnerCenter.NETSDK (NuGet Gallery | Microsoft.Store.PartnerCenter 1.16.3)](https://www.nuget.org/packages/Microsoft.Store.PartnerCenter/1.16.3)</span></span>
- <span data-ttu-id="2a8f2-386">[GitHub サンプル](https://github.com/Microsoft/Partner-Center-DotNet-Samples)をダウンロードして確認する</span><span class="sxs-lookup"><span data-stu-id="2a8f2-386">Download and review the [GitHub samples](https://github.com/Microsoft/Partner-Center-DotNet-Samples)</span></span>

______________

## <a name="december-2020-license-based-price-list-release-notes"></a><a name="3"></a><span data-ttu-id="2a8f2-387">2020 年 12 月のライセンスベースの価格表のリリース ノート</span><span class="sxs-lookup"><span data-stu-id="2a8f2-387">December 2020 license-based price list release notes</span></span>

### <a name="categories"></a><span data-ttu-id="2a8f2-388">Categories</span><span class="sxs-lookup"><span data-stu-id="2a8f2-388">Categories</span></span>

- <span data-ttu-id="2a8f2-389">日付:2020 年 12 月 8 日</span><span class="sxs-lookup"><span data-stu-id="2a8f2-389">Date: 2020-12-8</span></span>
- <span data-ttu-id="2a8f2-390">製品サービス/市場</span><span class="sxs-lookup"><span data-stu-id="2a8f2-390">Offers/Markets</span></span>

### <a name="summary"></a><span data-ttu-id="2a8f2-391">まとめ</span><span class="sxs-lookup"><span data-stu-id="2a8f2-391">Summary</span></span> 

<span data-ttu-id="2a8f2-392">2020 年 12 月のライセンスベースの価格表とオファー一覧表には、いくつかの問題があります。</span><span class="sxs-lookup"><span data-stu-id="2a8f2-392">The December 2020 license-based price list and offer list matrix have a few issues.</span></span>

### <a name="impacted-audience"></a><span data-ttu-id="2a8f2-393">影響を受ける対象ユーザー</span><span class="sxs-lookup"><span data-stu-id="2a8f2-393">Impacted Audience</span></span> 

<span data-ttu-id="2a8f2-394">クラウド ソリューション プロバイダー (CSP) プログラムを通じて取引を行う、すべてのパートナー様</span><span class="sxs-lookup"><span data-stu-id="2a8f2-394">All partners transacting through the Cloud Solution Provider (CSP) program</span></span>

### <a name="details"></a><span data-ttu-id="2a8f2-395">詳細</span><span class="sxs-lookup"><span data-stu-id="2a8f2-395">Details</span></span>

<span data-ttu-id="2a8f2-396">12 月のライセンスベースの価格表とオファー一覧表ファイルには、いくつかの問題があります。</span><span class="sxs-lookup"><span data-stu-id="2a8f2-396">The December license-based price lists and offer list matrix files contain a few anomalies.</span></span> <span data-ttu-id="2a8f2-397">これらの問題は、ライセンスベースの価格ファイルのみに関連しており、2021 年 1 月の更新プログラムで修正されます。</span><span class="sxs-lookup"><span data-stu-id="2a8f2-397">These issues are related only to the license-based pricing files and should be corrected in the January 2021 updates.</span></span>

#### <a name="incorrect-offers-in-the-license-based-price-list"></a><span data-ttu-id="2a8f2-398">ライセンスベースの価格表の誤ったオファー</span><span class="sxs-lookup"><span data-stu-id="2a8f2-398">Incorrect offers in the license-based price list</span></span>

<span data-ttu-id="2a8f2-399">12 月のライセンスベースの価格表には、価格表に掲載すべきでない以下のオファーが含まれています。</span><span class="sxs-lookup"><span data-stu-id="2a8f2-399">The December license-based price lists contain the below offers that should not be in the price lists.</span></span> <span data-ttu-id="2a8f2-400">これらのオファーは、以前誤って価格表に含まれていましたが、公開すべきものではありませんでした。</span><span class="sxs-lookup"><span data-stu-id="2a8f2-400">These offers were previously included in the price lists in error and should not have been published.</span></span> <span data-ttu-id="2a8f2-401">これらのオファーが利用可能になるタイミングについてスケジュールは決まっていません。</span><span class="sxs-lookup"><span data-stu-id="2a8f2-401">There is no schedule as to when these offers may be available.</span></span> <span data-ttu-id="2a8f2-402">今後、これらが再び追加される場合、今後のプレビュー料金表に [追加] として掲載されます。</span><span class="sxs-lookup"><span data-stu-id="2a8f2-402">In the future, if they are added back they will be listed as ADDs in future preview price lists.</span></span>

   |<span data-ttu-id="2a8f2-403">**プラン名**</span><span class="sxs-lookup"><span data-stu-id="2a8f2-403">**Offer name**</span></span>|<span data-ttu-id="2a8f2-404">**プラン ID**</span><span class="sxs-lookup"><span data-stu-id="2a8f2-404">**Offer ID**</span></span>|
   |-------------------|:------|
   |<span data-ttu-id="2a8f2-405">Dynamics 365 Human Resources (非営利価格)</span><span class="sxs-lookup"><span data-stu-id="2a8f2-405">Dynamics 365 Human Resources (Nonprofits Pricing)</span></span>|<span data-ttu-id="2a8f2-406">1596fa61-7da1-4263-98f8-b27dfa4cfbb5</span><span class="sxs-lookup"><span data-stu-id="2a8f2-406">1596fa61-7da1-4263-98f8-b27dfa4cfbb5</span></span>|
   |<span data-ttu-id="2a8f2-407">ご契約の Dynamics 365 基本オファーへの Dynamics 365 Human Resources アタッチ (非営利価格)</span><span class="sxs-lookup"><span data-stu-id="2a8f2-407">Dynamics 365 Human Resources Attach to Qualifying Dynamics 365 Base Offer (Nonprofits Pricing)</span></span>|<span data-ttu-id="2a8f2-408">8bf0b826-e05b-45aa-9cd1-9a9f742f7731</span><span class="sxs-lookup"><span data-stu-id="2a8f2-408">8bf0b826-e05b-45aa-9cd1-9a9f742f7731</span></span>|
   |<span data-ttu-id="2a8f2-409">ご契約の Dynamics 365 基本オファーへの Dynamics 365 Human Resources アタッチ (非営利価格) (対象オファー)</span><span class="sxs-lookup"><span data-stu-id="2a8f2-409">Dynamics 365 Human Resources Attach to Qualifying Dynamics 365 Base Offer (Nonprofits Pricing) (Qualified Offer)</span></span>|<span data-ttu-id="2a8f2-410">f906435d-9dc9-42ba-bea6-2a2b08ca60db</span><span class="sxs-lookup"><span data-stu-id="2a8f2-410">f906435d-9dc9-42ba-bea6-2a2b08ca60db</span></span>|
   |<span data-ttu-id="2a8f2-411">Dynamics 365 Human Resources サンドボックス (非営利価格)</span><span class="sxs-lookup"><span data-stu-id="2a8f2-411">Dynamics 365 Human Resources Sandbox (Nonprofits Pricing)</span></span>|<span data-ttu-id="2a8f2-412">079ec5ba-d726-4384-95af-62d135c210d2</span><span class="sxs-lookup"><span data-stu-id="2a8f2-412">079ec5ba-d726-4384-95af-62d135c210d2</span></span>|
   |<span data-ttu-id="2a8f2-413">Dynamics 365 Human Resources セルフ サービス (非営利価格)</span><span class="sxs-lookup"><span data-stu-id="2a8f2-413">Dynamics 365 Human Resources Self-Service (Nonprofits Pricing)</span></span>|<span data-ttu-id="2a8f2-414">931acecc-34c3-4f83-913e-c7fdbfd7e2a1</span><span class="sxs-lookup"><span data-stu-id="2a8f2-414">931acecc-34c3-4f83-913e-c7fdbfd7e2a1</span></span>|
   |<span data-ttu-id="2a8f2-415">Dynamics 365 Operations – 注文明細 (非営利価格)</span><span class="sxs-lookup"><span data-stu-id="2a8f2-415">Dynamics 365 Operations – Order Lines (Nonprofits Pricing)</span></span>|<span data-ttu-id="2a8f2-416">7dd6b78a-3d53-47f8-8a64-bd84609a9a70</span><span class="sxs-lookup"><span data-stu-id="2a8f2-416">7dd6b78a-3d53-47f8-8a64-bd84609a9a70</span></span>|
   
#### <a name="incorrect-offers-in-the-offer-list-matrix"></a><span data-ttu-id="2a8f2-417">オファー一覧表の誤ったオファー</span><span class="sxs-lookup"><span data-stu-id="2a8f2-417">Incorrect offers in the offer list matrix</span></span>
   
<span data-ttu-id="2a8f2-418">オファー一覧表の以下のオファーに誤りがありました。</span><span class="sxs-lookup"><span data-stu-id="2a8f2-418">Below offers were in the offer list matrix in error.</span></span> <span data-ttu-id="2a8f2-419">これらは使用できず、利用可能日は未定です。</span><span class="sxs-lookup"><span data-stu-id="2a8f2-419">They are not available, there is not target date yet for availability.</span></span> <span data-ttu-id="2a8f2-420">パートナー様に、これらの項目は無視してくださるようお願いいたします。</span><span class="sxs-lookup"><span data-stu-id="2a8f2-420">Partners should ignore these line items.</span></span>

   |<span data-ttu-id="2a8f2-421">**プラン名**</span><span class="sxs-lookup"><span data-stu-id="2a8f2-421">**Offer name**</span></span>|<span data-ttu-id="2a8f2-422">**プラン ID**</span><span class="sxs-lookup"><span data-stu-id="2a8f2-422">**Offer ID**</span></span>|
   |-------------------|:------|
   |<span data-ttu-id="2a8f2-423">Dynamics 365 Operations - データベース容量 (非営利価格)</span><span class="sxs-lookup"><span data-stu-id="2a8f2-423">Dynamics 365 Operations - Database Capacity (Nonprofits Pricing)</span></span>|<span data-ttu-id="2a8f2-424">1d3f4d81-89b9-419e-a880-31b2c50b8d66</span><span class="sxs-lookup"><span data-stu-id="2a8f2-424">1d3f4d81-89b9-419e-a880-31b2c50b8d66</span></span>|
   |<span data-ttu-id="2a8f2-425">Dynamics 365 Operations - ファイル容量 (非営利価格)</span><span class="sxs-lookup"><span data-stu-id="2a8f2-425">Dynamics 365 Operations - File Capacity (Nonprofits Pricing)</span></span>|<span data-ttu-id="2a8f2-426">dc173a86-285b-444c-881e-3ece531f67da</span><span class="sxs-lookup"><span data-stu-id="2a8f2-426">dc173a86-285b-444c-881e-3ece531f67da</span></span>|

#### <a name="powerapps-offer"></a><span data-ttu-id="2a8f2-427">Powerapps オファー</span><span class="sxs-lookup"><span data-stu-id="2a8f2-427">Powerapps offer</span></span>

<span data-ttu-id="2a8f2-428">このオファーは、オファー一覧表に含まれていましたが、12 月の価格表には含まれていませんでした。</span><span class="sxs-lookup"><span data-stu-id="2a8f2-428">This offer was included in the offer list matrix but not the December price list.</span></span> <span data-ttu-id="2a8f2-429">このオファーは利用可能で、価格は先月の価格表、11 月のファイルに記載されています。</span><span class="sxs-lookup"><span data-stu-id="2a8f2-429">The offer is available and pricing can be found in the previous month's price list November file.</span></span> <span data-ttu-id="2a8f2-430">このオファーは、1 月の価格表に再度追加されます。</span><span class="sxs-lookup"><span data-stu-id="2a8f2-430">This offer should be added back to the January price list.</span></span>

   |<span data-ttu-id="2a8f2-431">**プラン名**</span><span class="sxs-lookup"><span data-stu-id="2a8f2-431">**Offer name**</span></span>|<span data-ttu-id="2a8f2-432">**プラン ID**</span><span class="sxs-lookup"><span data-stu-id="2a8f2-432">**Offer ID**</span></span>|
   |-------------------|:------|
   |<span data-ttu-id="2a8f2-433">Power Apps per app プラン</span><span class="sxs-lookup"><span data-stu-id="2a8f2-433">Power Apps per app plan</span></span>|<span data-ttu-id="2a8f2-434">5e1087b6-246b-4503-b88a-b60bdf0b3840</span><span class="sxs-lookup"><span data-stu-id="2a8f2-434">5e1087b6-246b-4503-b88a-b60bdf0b3840</span></span>|

### <a name="next-steps"></a><span data-ttu-id="2a8f2-435">次のステップ</span><span class="sxs-lookup"><span data-stu-id="2a8f2-435">Next steps</span></span>

<span data-ttu-id="2a8f2-436">他の未掲載の問題がこのお知らせに追加されるため、リリース ノートを頻繁にご確認ください。</span><span class="sxs-lookup"><span data-stu-id="2a8f2-436">Check release notes often as other issues are uncovered they will be appended to this announcement.</span></span>

### <a name="last-updated"></a><span data-ttu-id="2a8f2-437">最終更新日</span><span class="sxs-lookup"><span data-stu-id="2a8f2-437">Last updated</span></span>

<span data-ttu-id="2a8f2-438">2020 年 12 月 8 日</span><span class="sxs-lookup"><span data-stu-id="2a8f2-438">December 8, 2020</span></span>

______________

## <a name="an-update-of-the-us-microsoft-365-business-voice-with-calling-plan-offer-is-coming-soon"></a><a name="2"></a><span data-ttu-id="2a8f2-439">通話プラン サービスのある米国 Microsoft 365 Business Voice の更新が近日公開予定</span><span class="sxs-lookup"><span data-stu-id="2a8f2-439">An update of the US Microsoft 365 Business Voice with Calling Plan offer is coming soon</span></span>

### <a name="categories"></a><span data-ttu-id="2a8f2-440">Categories</span><span class="sxs-lookup"><span data-stu-id="2a8f2-440">Categories</span></span>

- <span data-ttu-id="2a8f2-441">日付:2020 年 12 月 3 日</span><span class="sxs-lookup"><span data-stu-id="2a8f2-441">Date: 2020-12-3</span></span>
- <span data-ttu-id="2a8f2-442">製品サービス/市場</span><span class="sxs-lookup"><span data-stu-id="2a8f2-442">Offers/Markets</span></span>

### <a name="summary"></a><span data-ttu-id="2a8f2-443">まとめ</span><span class="sxs-lookup"><span data-stu-id="2a8f2-443">Summary</span></span> 

<span data-ttu-id="2a8f2-444">Microsoft は、2021 年 1 月 1 日に、米国のパートナー様とお客様の、通話プラン サービスのある新しい Microsoft 365 Business Voice への移行を開始します。</span><span class="sxs-lookup"><span data-stu-id="2a8f2-444">On January 1, 2021, Microsoft will begin transitioning US partners and customers to a new Microsoft 365 Business Voice with Calling Plan offer.</span></span> <span data-ttu-id="2a8f2-445">パートナー側での操作は必要ありません。</span><span class="sxs-lookup"><span data-stu-id="2a8f2-445">No partner action is required.</span></span>

### <a name="impacted-audience"></a><span data-ttu-id="2a8f2-446">影響を受ける対象ユーザー</span><span class="sxs-lookup"><span data-stu-id="2a8f2-446">Impacted Audience</span></span> 

<span data-ttu-id="2a8f2-447">クラウド ソリューション プロバイダー (CSP) プログラムを通じて取引を行う、すべてのパートナー様</span><span class="sxs-lookup"><span data-stu-id="2a8f2-447">All partners transacting through the Cloud Solution Provider (CSP) program</span></span>

### <a name="details"></a><span data-ttu-id="2a8f2-448">詳細</span><span class="sxs-lookup"><span data-stu-id="2a8f2-448">Details</span></span>

<span data-ttu-id="2a8f2-449">Microsoft は、米国内の通話プラン サービスのある既存の Business Voice を新しいオファーに置き換えて、通信製品の社内要件をサポートします。</span><span class="sxs-lookup"><span data-stu-id="2a8f2-449">Microsoft will replace the existing Business Voice with Calling plan offer in the US with a new offer to support internal requirements for telco products.</span></span> <span data-ttu-id="2a8f2-450">新しいオファーの機能セットと価格は変わりません。</span><span class="sxs-lookup"><span data-stu-id="2a8f2-450">The new offer will have the same feature set and pricing.</span></span> <span data-ttu-id="2a8f2-451">オファーの変更は Microsoft 内部のものであり、CSP パートナー様が通話プラン サービスのある Business Voice をマーケティング、販売、サポートする方法に影響を与えることはありません。</span><span class="sxs-lookup"><span data-stu-id="2a8f2-451">The offer changes are internal to Microsoft and should not affect the way that CSP partners market, sell, or support the Business Voice with Calling Plan offer.</span></span> <span data-ttu-id="2a8f2-452">変更は、このオファーにのみ適用されます。</span><span class="sxs-lookup"><span data-stu-id="2a8f2-452">The change will only apply to this offer.</span></span>

<span data-ttu-id="2a8f2-453">新規販売では、2021 年 1 月 1 日から始まる新しいオファーを使用します。</span><span class="sxs-lookup"><span data-stu-id="2a8f2-453">For new sales, you will use the new offer starting on January 1, 2021.</span></span> <span data-ttu-id="2a8f2-454">古いオファーは、価格表で新しいオファーに置き換えられます。</span><span class="sxs-lookup"><span data-stu-id="2a8f2-454">The old offer will be replaced by the new offer on the price list.</span></span>

<span data-ttu-id="2a8f2-455">既存のお客様は、更新日に新しいオファーに自動的に移行されます。</span><span class="sxs-lookup"><span data-stu-id="2a8f2-455">Existing customers will be automatically transitioned to the new offer upon their renewal date.</span></span> <span data-ttu-id="2a8f2-456">パートナー様や新規のお客様が対応を行う必要はありません。</span><span class="sxs-lookup"><span data-stu-id="2a8f2-456">No action is required from partners and renewing customers.</span></span>


<span data-ttu-id="2a8f2-457">\*\* 新しいオファーの詳細</span><span class="sxs-lookup"><span data-stu-id="2a8f2-457">\*\*New offer details</span></span>
 
   |<span data-ttu-id="2a8f2-458">**プラン名**</span><span class="sxs-lookup"><span data-stu-id="2a8f2-458">**Offer name**</span></span>|<span data-ttu-id="2a8f2-459">**プラン ID**</span><span class="sxs-lookup"><span data-stu-id="2a8f2-459">**Offer ID**</span></span>|<span data-ttu-id="2a8f2-460">**マテリアル ID**</span><span class="sxs-lookup"><span data-stu-id="2a8f2-460">**Material ID**</span></span>|
   |-------------------|:------|:------|
   |<span data-ttu-id="2a8f2-461">Microsoft 365 Business Voice (US)</span><span class="sxs-lookup"><span data-stu-id="2a8f2-461">Microsoft 365 Business Voice (US)</span></span>|<span data-ttu-id="2a8f2-462">86713ec1-ad33-42cf-a1ce-8397d4d875fe</span><span class="sxs-lookup"><span data-stu-id="2a8f2-462">86713ec1-ad33-42cf-a1ce-8397d4d875fe</span></span>|<span data-ttu-id="2a8f2-463">PZW-00023</span><span class="sxs-lookup"><span data-stu-id="2a8f2-463">PZW-00023</span></span>|
   
<span data-ttu-id="2a8f2-464">\*\* 古いオファーの詳細</span><span class="sxs-lookup"><span data-stu-id="2a8f2-464">\*\*Old offer details</span></span>

   |<span data-ttu-id="2a8f2-465">**プラン名**</span><span class="sxs-lookup"><span data-stu-id="2a8f2-465">**Offer name**</span></span>|<span data-ttu-id="2a8f2-466">**プラン ID**</span><span class="sxs-lookup"><span data-stu-id="2a8f2-466">**Offer ID**</span></span>|<span data-ttu-id="2a8f2-467">**マテリアル ID**</span><span class="sxs-lookup"><span data-stu-id="2a8f2-467">**Material ID**</span></span>|
   |-------------------|:------|:------|
   |<span data-ttu-id="2a8f2-468">Microsoft 365 Business Voice (US)</span><span class="sxs-lookup"><span data-stu-id="2a8f2-468">Microsoft 365 Business Voice (US)</span></span>|<span data-ttu-id="2a8f2-469">9f9f2c7b-c961-402b-9421-8e3c9207eeb3</span><span class="sxs-lookup"><span data-stu-id="2a8f2-469">9f9f2c7b-c961-402b-9421-8e3c9207eeb3</span></span>|<span data-ttu-id="2a8f2-470">PZW-00009</span><span class="sxs-lookup"><span data-stu-id="2a8f2-470">PZW-00009</span></span>|

### <a name="next-steps"></a><span data-ttu-id="2a8f2-471">次のステップ</span><span class="sxs-lookup"><span data-stu-id="2a8f2-471">Next steps</span></span>

<span data-ttu-id="2a8f2-472">価格表についての詳細を理解し、組織内のすべての適切な担当者にこの情報を共有します。</span><span class="sxs-lookup"><span data-stu-id="2a8f2-472">Familiarize yourself with the price list and share this information with all appropriate contacts in your organization.</span></span>

______________

## <a name="now-live-partner-center-api-updates-and-user-interface-enhancements-for-the-education-customer-validation-process"></a><a name="1"></a><span data-ttu-id="2a8f2-473">公開中:教育機関の顧客の検証プロセスにおけるパートナー センター API の更新とユーザー インターフェイスの機能強化</span><span class="sxs-lookup"><span data-stu-id="2a8f2-473">Now live: Partner Center API updates and user interface enhancements for the Education customer validation process</span></span>

### <a name="categories"></a><span data-ttu-id="2a8f2-474">Categories</span><span class="sxs-lookup"><span data-stu-id="2a8f2-474">Categories</span></span>

- <span data-ttu-id="2a8f2-475">日付:2020 年 12 月 3 日</span><span class="sxs-lookup"><span data-stu-id="2a8f2-475">Date: 2020-12-3</span></span>
- <span data-ttu-id="2a8f2-476">機能</span><span class="sxs-lookup"><span data-stu-id="2a8f2-476">Capabilities</span></span>

### <a name="impacted-audience"></a><span data-ttu-id="2a8f2-477">影響を受ける対象ユーザー</span><span class="sxs-lookup"><span data-stu-id="2a8f2-477">Impacted Audience</span></span> 

<span data-ttu-id="2a8f2-478">クラウド ソリューション プロバイダー プログラムを通じてアカデミック向けオファーを販売しているパートナー様</span><span class="sxs-lookup"><span data-stu-id="2a8f2-478">Partners selling Academic offers through the Cloud Solution Provider program</span></span>

### <a name="summary"></a><span data-ttu-id="2a8f2-479">まとめ</span><span class="sxs-lookup"><span data-stu-id="2a8f2-479">Summary</span></span> 

<span data-ttu-id="2a8f2-480">Microsoft の基盤は信頼です。</span><span class="sxs-lookup"><span data-stu-id="2a8f2-480">Microsoft runs on trust.</span></span> <span data-ttu-id="2a8f2-481">Microsoft は、クラウド ソリューション プロバイダー プログラムにおけるアカデミック向けオファーの取引を行うにあたって顧客を検証するための、法令に準拠した安全な手段の提供に努めています。</span><span class="sxs-lookup"><span data-stu-id="2a8f2-481">We are committed to providing a compliant, safe, and secure method of customer validation for transacting Academic offers in the Cloud Solution Provider program.</span></span> <span data-ttu-id="2a8f2-482">このコミットメントの一環として、顧客の審査プロセスの明瞭性と可視性が向上し、より正確なデータを入力できるようになるパートナー センター API とユーザー インターフェイスの機能強化を導入する予定です。これにより、顧客審査の成功率が上がります。</span><span class="sxs-lookup"><span data-stu-id="2a8f2-482">As part of this commitment, we are introducing Partner Center API and user interface enhancements that will add clarity and visibility into the customer vetting process as well as the ability to input more accurate data, which will drive improved customer vetting success.</span></span> 

<span data-ttu-id="2a8f2-483">**パートナー センターの機能強化**</span><span class="sxs-lookup"><span data-stu-id="2a8f2-483">**Partner Center enhancements**</span></span> 

- <span data-ttu-id="2a8f2-484">正確なデータ入力をサポートし、Microsoft による教育機関顧客の検証プロセスを改善するための新しい GET および POST Qualifications API。</span><span class="sxs-lookup"><span data-stu-id="2a8f2-484">New GET and POST Qualifications APIs to support accurate data entry and improve the Education customer validation process by Microsoft.</span></span> 

- <span data-ttu-id="2a8f2-485">正確なデータ入力をサポートし、Microsoft による教育機関顧客の検証プロセスを改善するためのユーザー インターフェイスの拡張機能。</span><span class="sxs-lookup"><span data-stu-id="2a8f2-485">User interface enhancements to support accurate data entry and improve the Education customer validation process by Microsoft.</span></span> 

<span data-ttu-id="2a8f2-486">**既存の GET および PUT 認定 API の非推奨**</span><span class="sxs-lookup"><span data-stu-id="2a8f2-486">**Deprecation of existing GET and PUT Qualification APIs**</span></span> 

<span data-ttu-id="2a8f2-487">既存の GET および PUT 認定 API は、**2021 年 2 月末まで** に廃止されます。</span><span class="sxs-lookup"><span data-stu-id="2a8f2-487">The existing GET and PUT Qualification APIs will retire **before the end of February 2021**.</span></span> <span data-ttu-id="2a8f2-488">教育機関向け特価プランを購入できるようにするには、その時点で、新しい GET および POST パートナー センター API に移行している必要があります。</span><span class="sxs-lookup"><span data-stu-id="2a8f2-488">At that time, you will need to have transitioned to the new GET and POST Partner Center APIs in order to be able to purchase Education offers.</span></span>  

<span data-ttu-id="2a8f2-489">**テスト**</span><span class="sxs-lookup"><span data-stu-id="2a8f2-489">**Testing**</span></span> 

<span data-ttu-id="2a8f2-490">顧客検証の成功に必要な API とデータ入力について理解を深めるために、パートナー様はこれらの拡張機能をテストすることができます。</span><span class="sxs-lookup"><span data-stu-id="2a8f2-490">To gain a better understanding of the APIs and data entry required for successful customer validation, partners can test these enhancements.</span></span> <span data-ttu-id="2a8f2-491">テストへの参加を希望するパートナー様は、[パートナー センターの教育機関の顧客向けテスト ガイド](https://partner.microsoft.com/resources/detail/partner-center-edu-testing-guide-pdf)をダウンロードして、事前の準備やサインアップの方法、およびテスト段階で行うことに関する情報をご覧ください。</span><span class="sxs-lookup"><span data-stu-id="2a8f2-491">Partners who want to participate in the testing should download the [Partner Center Education customer testing guide](https://partner.microsoft.com/resources/detail/partner-center-edu-testing-guide-pdf) for directions on how to prepare, sign up, and for information on what to expect during the testing phase.</span></span>

<span data-ttu-id="2a8f2-492">**図書館と博物館の顧客**</span><span class="sxs-lookup"><span data-stu-id="2a8f2-492">**Library and Museum customers**</span></span> 

<span data-ttu-id="2a8f2-493">上記の拡張機能に加えて、Microsoft は、CSP オファーを取り引きできる教育機関の顧客を拡大する、図書館および博物館の顧客向けアカデミック価格のオファーを提供できるようになることをお知らせいたします。</span><span class="sxs-lookup"><span data-stu-id="2a8f2-493">In addition to the above enhancements, we are excited to announce that we will enable Academic-priced offers for Library and Museum customers, expanding the Education customers with whom you can transact CSP offers.</span></span> 

<span data-ttu-id="2a8f2-494">Microsoft では、すべての顧客または提案された顧客の適格教育ユーザーとしての状態をレビューする権利を留保します。</span><span class="sxs-lookup"><span data-stu-id="2a8f2-494">Microsoft reserves the right to review the status of any customer or proposed customer as a qualified educational user.</span></span> <span data-ttu-id="2a8f2-495">詳細については、[アカデミック適格教育ユーザーの要件](https://www.microsoftvolumelicensing.com/DocumentSearch.aspx?Mode=3&DocumentTypeId=7)を参照してください。</span><span class="sxs-lookup"><span data-stu-id="2a8f2-495">See the [Academic Qualified Education User Requirements](https://www.microsoftvolumelicensing.com/DocumentSearch.aspx?Mode=3&DocumentTypeId=7) for full details.</span></span> 

### <a name="next-stepsadditional-resources"></a><span data-ttu-id="2a8f2-496">次のステップ/追加のリソース</span><span class="sxs-lookup"><span data-stu-id="2a8f2-496">Next steps/additional resources</span></span>

- <span data-ttu-id="2a8f2-497">パートナー センターの新しいユーザー インターフェイス、API の変更内容、およびガイドを次のオペレーション レディネス リソースで確認します。[パートナー センターの教育機関顧客検証](https://partner.microsoft.com/resources/collection/partner-center-edu-validation-enhancements#/)プロセスの機能強化</span><span class="sxs-lookup"><span data-stu-id="2a8f2-497">Review the new Partner Center User Interface, API changes, and Guide in the Operations Readiness resources:  [Partner Center Education customer validation](https://partner.microsoft.com/resources/collection/partner-center-edu-validation-enhancements#/) process enhancements</span></span> 

- <span data-ttu-id="2a8f2-498">パートナー様の組織が[アカデミック適格教育ユーザーの要件](https://www.microsoftvolumelicensing.com/DocumentSearch.aspx?Mode=3&DocumentTypeId=7)について理解していることを確認します。</span><span class="sxs-lookup"><span data-stu-id="2a8f2-498">Ensure your organization is familiar with the [Academic Qualified Education User requirements](https://www.microsoftvolumelicensing.com/DocumentSearch.aspx?Mode=3&DocumentTypeId=7).</span></span> 

- <span data-ttu-id="2a8f2-499">この情報を組織内の該当するチームやリセラーと共有し、これらの変更内容に対して準備できるようにします。</span><span class="sxs-lookup"><span data-stu-id="2a8f2-499">Share this information with the appropriate teams within your organization, and with your resellers, to help them prepare for these changes.</span></span> 

### <a name="change-log"></a><span data-ttu-id="2a8f2-500">変更履歴</span><span class="sxs-lookup"><span data-stu-id="2a8f2-500">Change Log</span></span> 

<span data-ttu-id="2a8f2-501">_ 2020 年 8 月 31 日:初版の発行日</span><span class="sxs-lookup"><span data-stu-id="2a8f2-501">_ August 31, 2020:  Original publication</span></span> 

- <span data-ttu-id="2a8f2-502">2020 年 9 月 25 日テスト ウィンドウの更新が追加されました</span><span class="sxs-lookup"><span data-stu-id="2a8f2-502">September 25, 2020:  Test window update added</span></span> 

- <span data-ttu-id="2a8f2-503">2020 年 10 月 4 日テストのサインアップのリマインダー</span><span class="sxs-lookup"><span data-stu-id="2a8f2-503">October 4, 2020: Reminder to sign up for testing</span></span> 

- <span data-ttu-id="2a8f2-504">2020 年 11 月 10 日テストのサインアップのリマインダー</span><span class="sxs-lookup"><span data-stu-id="2a8f2-504">November 10, 2020: Reminder to sign up for testing</span></span> 

- <span data-ttu-id="2a8f2-505">2020 年 12 月 3 日API の更新の公開</span><span class="sxs-lookup"><span data-stu-id="2a8f2-505">December 3, 2020: API updates live</span></span>
