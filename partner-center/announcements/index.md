...
|**カテゴリ**|**2021 年 7 月のお知らせ**|**発表**|
|---------|:---------|:---------|
|機能|[今月の製品発売とプランを見る](2021-july.md#2)|7 月 1 日|
|機能|[Dynamics 365 クラウド移行のプロモーションと割引オファーの提供終了](2021-july.md#1)|7 月 1 日|
|**カテゴリ**|**2021 年 6 月のお知らせ**|**発表**|
|機能|[フェーズ 2 の更新: EU と EFTA および英国での新しいコマース オファーに関するパートナー請求通貨の変更](2021-june.md#9)|6 月 24 日|
|機能|[最新のプロモーションとオファーを表示する](2021-june.md#8)|6 月 22 日|
|機能|[フェーズ 1: 近日公開予定の新しいコマース エクスペリエンスに関連するクラウド ソリューション プロバイダー (CSP) での Azure オファーの提供状況に対する変更](2021-june.md#7)|6 月 21 日|
|ビジネスの拡大|[6 月のクラウド ソリューション プロバイダー (CSP) コミュニティの更新とリマインダー](2021-june.md#6)|6 月 11 日|
|製品サービスと市場|[Microsoft 365 Audio Conferencing と Microsoft 365 Business Voice 用のクラウド ソリューション プロバイダー (CSP) プロモーションの拡張機能](2021-june.md#5)|6 月 11 日|
|機能|[永続的ソフトウェアの価格表が修正され再発行されました](2021-june.md#4)|6 月 4 日|
|機能|[7 月のライセンスベース サービスの価格表プレビューへの修正](2021-june.md#3)|6 月 4 日|
|機能|[Azure 使用状況レポートのより詳しい情報のための列の追加](2021-june.md#2)|6 月 2 日|
|機能|[今月の製品発売とプランを見る](2021-june.md#1)|6 月 1 日|
|**カテゴリ**|**2021 年 5 月のお知らせ**|**発表**|
|機能|[エンド ツー エンドの API テストを有効にするための間接モデルに対するサンドボックスのサポート](2021-may.md#15)|5 月 25 日|
|機能、セキュリティとコンプライアンスの強化 |[オンライン サービス (OLS) とソフトウェア チャネルの承認ガイドの 6 月の更新](2021-may.md#14)|5 月 25 日|
