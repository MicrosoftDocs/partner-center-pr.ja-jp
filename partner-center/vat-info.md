...
|ベルギー  |-VAT 番号の形式:10 桁<br/>- 国/地域コード: BE<br/>- 例: 1234567890<br/>- 注: 2007 年 1 月 1 日より前の 9 桁。 |
| ブルガリア  |- VAT 番号の形式: 9 桁または 10 桁<br/>- 国/地域コード: BG<br/>- 例: 123456789 または 0123456789 |
| クロアチア |- VAT 番号形式: 2 文字と 11 桁<br/>- 国/地域コード: HR<br/>- 例: HR12345678901<br/>- 注: 最初の文字は常に "HR" になります。 |
|キプロス |- VAT 番号形式: 2 文字、8 桁の数字、1 文字<br/>- 国/地域コード: CY<br/>- 例: 12345678、123456789、または 0123456789 |
|チェコ |- VAT 番号の形式: 8 桁、9 桁、または 10 桁<br/>- 国/地域コード: CZ<br/>- 例: 12345678、123456789、または 0123456789 |
| デンマーク |- VAT 番号形式: 8 桁<br/>- 国/地域コード: DK<br/>- 例: 12345678<br/> |
|エストニア |- VAT 番号形式: 9 桁<br/>-国/地域コード: EE<br/>-例: 123456789<br/> |
...
|アイルランド |-VAT 番号の形式: 8 桁<br/>- 国/地域コード: IE<br/>- 例: 1234567X または 1X34567X<br/>- 注: 1 文字または 2 文字のアルファベット文字 (最後または 2 番目と最後) が含まれます。 |
|イタリア |- VAT 番号形式: 11 桁<br/>- 国/地域コード: IT<br/>- 例: 12345678901 |
|ラトビア |- VAT 番号形式: 11 桁<br/>- 国/地域コード: LV<br/>- 例: 01234567890 |
|リトアニア |- VAT 番号の形式: 9 桁または 12 桁<br/>- 国/地域コード: LT<br/>- 例: 123456789 または 012345678901 |
...
|オランダ |- VAT 番号形式: 11 桁と 1 文字<br/>-国/地域コード: NL<br/>-例: の使用例<br/>-注:10 番目の文字は常に ' B ' です。 |
