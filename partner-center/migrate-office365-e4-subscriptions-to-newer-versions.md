...
- オプション 2:Office 365 Enterprise E3 + Skype for Business クラウド PBX

- オプション 3: Office 365 Enterprise E3 + Skype for Business Plus CAL (料金と機能は E4 相当)
...
1. **パートナー センター** メニューで **[顧客]** を選択し、移行する顧客を選択した後、**[ユーザーとライセンス]** を選択します。 お客様の [ユーザーとライセンス] ページが開きます。
