...
支払 **い明細書には** 、コマーシャル マーケットプレースを通じて販売されたオファーからの支払いの概要が示されます。 収益のトランザクション履歴を表示し、次の支払いを見積もり、支払いの傾向を示します。 トランザクション履歴と支払い明細書をダウンロードできます。 この記事では、支払い明細書にアクセスする方法と、お客様がアクセスできるさまざまな支払いページとダウンロードについてパートナー センター。

>[!NOTE]
>関連付けられている MPN の ID とプログラムのデータだけが表示されます。 追加のデータを表示する場合は、アカウント管理者と一緒にアクセス許可を確認してください。 

## <a name="roles-and-permissions"></a>ロールとアクセス許可

支払い明細書にアクセスするには、アカウント所有者または財務共同 **作成者ロール** を割 **り当てる必要** があります。
...
サインイン [して](https://partner.microsoft.com/dashboard/home) パートナー センター画面の右上隅にある支払いアイコンを選択して、次のさまざまな概要にアクセスします。
...
パートナー支払い API を使用 [して](https://apidocs.microsoft.com/services/partnerpayouts) 接続し、支払いトランザクションと支払いデータを直接取得することもできます。


## <a name="transaction-history"></a>取引履歴

[ **トランザクション履歴]** ページには、過去 36 か月間の収益の概要、次の支払いの見積もり、収益と支払いの傾向が表示されます。 このセクションからトランザクションの詳細をダウンロードできます。<br><br>このレポートには、支払いの対象となるすべての収益 (まだ送信されていない支払いを含む) が表示されます。 収益は、ISV が パートナー センター のすべての銀行情報と税金情報を完了し、>$50 を獲得し、ISV アカウントがアクティブで、顧客が (EA トランザクションの場合) 請求された場合、または支払いが受け取られた場合 (EA 以外のトランザクションの場合) に支払う資格があります。

:::image type="content" source="images/payouts/transaction-overview.png" alt-text="トランザクションの概要。":::

- **今年送信された収益** – 支払われた収益の合計と内訳は、次の月に支払われます。
...
| paymentId | トランザクションレポートのすべてのトランザクションを、支払いレポートの特定の支払いと関連付けるための一意の識別子 | すべて |
...
>[!Note]
> 支払いの対象となるには、収益が $50 の[支払いしきい値](payment-thresholds-methods-timeframes.md)に達している必要があります。 詳細については、「Microsoft パブリッシャー契約 [」を参照してください](/legal/marketplace/msft-publisher-agreement)。
...
| Failed | Microsoft システム エラーが原因で支払いが失敗しました。 | 詳細については、Microsoft サポートにお問い合わせください |
| 進行中 | 支払いが進行中です。 | いいえ |
