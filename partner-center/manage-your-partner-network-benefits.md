...
>[!IMPORTANT]
>特典を購入する組織のグローバル管理者である必要はありません中、を従業員に特典を割り当てるグローバル管理者である必要があります。  [**特典**のページ](https://partnercenter.microsoft.com/pcv/partnership/benefits)上の手順に従って、グローバル管理者する場合は、なることができます (サインインが必要)。 また、組織は、チームを確認することを確認するためのグローバル管理者を既にがあります。
