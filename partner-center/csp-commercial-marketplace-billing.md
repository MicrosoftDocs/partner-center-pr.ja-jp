...
各列が表す内容の詳細については、「[請求書と調整ファイル間の料金のマッピング](use-the-reconciliation-files.md#mapping-charges-between-an-invoice-and-the-reconciliation-file)」を参照してください。 「[パートナーセンターでの課金の種類につい](billing-different-types.md#billing-for-one-time-and-select-recurring-charges)て」も参照してください。
